-- Fix the trigger function to use jsonb_array_length instead of array_length
      ...
      INSERT INTO public.patient_vaccine_tracking (
        ...
        CASE 
          ...
          ELSE NEW.appointment_date + COALESCE(
            (schedule_record.dose_intervals->>LEAST(dose_count::text, (jsonb_array_length(schedule_record.dose_intervals) - 1)::text))::integer, 
            30
          )
        END,
        CASE 
